...
<div class="layui-fluid">
    <div class="layui-card">
        <div class="layui-form layui-card-header layuiadmin-card-header-auto">
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    <button class="layui-btn" data-type="add_perm" id="add_perm">添加权限</button>
                </div>
                ...
                <div class="layui-inline">
                    <!-- 搜索按钮 -->
                    <button class="layui-btn " lay-submit lay-filter="LAY-perm-search"  id="btn_search">
        ...
        <div class="layui-card-body">
            <!-- 表格容器 -->
            <table id="LAY-perm-manage" lay-filter="LAY-perm-manage"></table>
...
<script>
    ...
    layui.use(['table','form'], function () {
        ...
        //监听搜索
        form.on('submit(LAY-perm-search)', function (data) {
        ...
        //表头按钮监听
        table.on('toolbar(LAY-perm-manage)', function (obj) {
            var checkStatus = table.checkStatus('LAY-perm-manage');
            ...
            switch (obj.event) {
                case 'update':
                    layer.open({
                        type: 2,
                        title: '编辑权限',
                        content: '${baseurl}/perm/updatePage?id=' + selectData[0].id,
                        maxmin: true,
                        area: ['820px', '600px'],
                        btn: ['确定', '取消'],
                        yes: todo
                ...
                case 'delete':
                    layer.confirm('确认要删除吗？', function () {
                        ...
                        console.log(ids);
                        $.get("${baseurl}/perm/delete?ids=" + ids, function (data) {
        ...
        // 表格元素选中显示按钮
        table.on('checkbox(LAY-perm-manage)', function (obj) {
            var checkStatus = table.checkStatus('LAY-perm-manage');
            ...
            iframeWindow.layui.form.on('submit(' + submitID + ')',
                function (data) {
                    ...
                    if (field.updateOrSave == "") {
                        //处理新增逻辑
                        var url = '${baseurl}/perm/save';
                    } else {
                        //处理更新逻辑
                        var url = '${baseurl}/perm/update';
                    }
